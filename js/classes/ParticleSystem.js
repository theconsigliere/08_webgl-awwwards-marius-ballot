...
class ParticleSystem {
  ...
  update(time) {
    ...
    while (i < this.particleCount) {
      // this.particlesGeom.attributes.position.array[i * 3 + 0] += 0.01 // x
      this.particlesGeom.attributes.position.array[i * 3 + 1] += 0.01 // y
      // this.particlesGeom.attributes.position.array[i * 3 + 2] += 0.01 //z

      // reload the articles to the bottom of the box once they reach the top of Y axis
      if (
